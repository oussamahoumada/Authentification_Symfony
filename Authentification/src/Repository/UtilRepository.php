 ...
 */
class UtilRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(Util $entity, bool $flush = false): void
    {
